...
$("#player").pPlayer({
  // youtubeVideoId: 'gnRbXn4-Yis',
  youtubeVideoId: 'gfu93WZ6HXQ',
  autoplay: 0
});


$('<div class="cover" />').prependTo($("#player"));
$handle = $('<span class="handle" />').appendTo($('.progressBar'));
...
$('#player').on('click', '.cover', function () {
  removeCover();
  $('#player .play').click();
})

$('#player').on('click', '.play, .enterFullscreen, .progressBar', function () {
  removeCover();
})